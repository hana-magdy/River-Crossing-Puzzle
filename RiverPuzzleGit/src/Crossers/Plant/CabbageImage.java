...
public class CabbageImage {
    ...
    public CabbageImage(Image LeftImage , Image RightImage) {
        this.LeftImage=LeftImage;
        this.RightImage=RightImage;
        this.LeftPositionX=280;
        this.LeftPositionY=420;
        this.LeftWidth=80;
        this.LeftHeight=130;
        this.RightPositionX=1200;
        this.RightpositionY=620;
